        ...
        public async Task ProcessPaymentAsync(Guid orderId)
        {
            ...
            try
            {
                ...
                await retryPolicy.ExecuteAsync(async () =>
                {
                    ...
                    {
                        order.Status = (Domain.Enums.OrderStatus)OrderStatus.PaymentProcessed;
            ...
            catch (Exception ex)
            {
                ...
                if (order != null && order.Status != (Domain.Enums.OrderStatus)OrderStatus.Failed)
                {
                    order.Status = (Domain.Enums.OrderStatus)OrderStatus.Failed;
        ...
        public async Task SendOrderConfirmationEmailAsync(Guid orderId)
        {
            ...
            try
            {
                ...
                await retryPolicy.ExecuteAsync(async () =>
                {
                    ...
                    if (order.Status == (Domain.Enums.OrderStatus)OrderStatus.Failed)
                    {
        ...
        public async Task FinalizeOrderAsync(Guid orderId)
        {
            ...
            try
            {
                ...
                await retryPolicy.ExecuteAsync(async () =>
                {
                    ...
                    if (order.Status.Equals(OrderStatus.PaymentProcessed))
                    {
                        order.Status = (Domain.Enums.OrderStatus)OrderStatus.Fulfilled;
