...
namespace ElectricityShop.API.Controllers
{
    ...
    public class TelemetryExampleControllerV2 : ControllerBase
    {
        private readonly ILogger<TelemetryExampleControllerV2> _controllerLogger;

        public TelemetryExampleControllerV2(ILogger<TelemetryExampleControllerV2> logger)
        {
